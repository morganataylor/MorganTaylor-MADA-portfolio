...
# Required Packages
The following packages are required to replicate this analysis:

* tidytuesdayR - used to load data (typically) and .Rmd template
* here - used to define location of data
* utils - used to import data
* tidyverse - used to load all packages in the Tidyverse (ggplot2, dyplr, tidyr, readr, purr, tibble, stringr, forcats)
* knitr - used to make pretty tables
* kableExtra - also used to make pretty tables
* scales - used to add commas to y-axis of figures
